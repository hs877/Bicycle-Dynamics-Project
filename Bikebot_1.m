...
c = 0.0448; %0.08;%orthogonal distance from steer axis to front wheel contact to ground, Q
w = 0.96468; %1.02;%wheel span
lambda = pi/10; %camber angle (radians)

%mass of four rigid bodies
m_R = 3.405; %2;%rear wheel mass
m_B = 17.71; %85;%rear frame mass
m_H = 1.61; %4;%front frame mass
m_F = 3.405; %3;%front wheel mass

%COM_x distance of both frames
x_B = 0.4521963; %0.3;%rear frame COM_x 
x_H = 0.865528645; %0.9;%front frame COM_x

%radius of wheels
r_R = 0.254; %0.3;%rear wheel radius
r_F = 0.254; %0.35;%front wheel radius

%COM_z distance of both frames
z_B = -0.371334; %-0.9;%rear frame COM_z
z_H = -0.32045; %-0.7;%front frame COM_z
